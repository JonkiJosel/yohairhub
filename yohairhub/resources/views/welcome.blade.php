...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('looks/css/open-iconic-bootstrap.min.css')}}">
        <link rel="stylesheet" href="{{asset('looks/css/animate.css')}}">
        
        <link rel="stylesheet" href="{{asset('looks/css/owl.carousel.min.css')}}">
        <link rel="stylesheet" href="{{asset('looks/css/owl.theme.default.min.css')}}">
        <link rel="stylesheet" href="{{asset('looks/css/magnific-popup.css')}}">

        <link rel="stylesheet" href="{{asset('looks/css/aos.css')}}">

        <link rel="stylesheet" href="{{asset('looks/css/ionicons.min.css')}}">

        <link rel="stylesheet" href="{{asset('looks/css/bootstrap-datepicker.css')}}">
        <link rel="stylesheet" href="{{asset('looks/css/jquery.timepicker.css')}}">

        
        <link rel="stylesheet" href="{{asset('looks/css/flaticon.css')}}">
        <link rel="stylesheet" href="{{asset('looks/css/icomoon.css')}}">
        <link rel="stylesheet" href="{{asset('looks/css/style.css')}}">
    ...
    <body>
        ...
        <div id="colorlib-page">
          ...
          <section class="ftco-section-2">
                ...
                <div class="section-2-blocks-wrapper d-flex row no-gutters">
                  ...
                  <div class="text col-md-6 ftco-animate">
                    <div class="text-inner align-self-start">
                      ...
                      <p>Join us and elevent your business to new heights.</p><p>Together, let's redifine beauty excellence</p>
                      {{-- <ul class="my-4">
                      ...
                      <div class="row">
                          <div class="col-md-7 ftco-animate">
                              <div class="img-2 d-flex justify-content-center align-items-center" style="background-image: url('{{asset('looks/images/bg_1.jpg')}}');">
                              ...
                              <div class="col-md-4 d-md-flex align-items-center">
                                  <h3 class="watchvideo-heading"><a href="#"><span class="ion-ios-play"></span> Watch our video to learn how to register your salon</a></h3>
                              </div>
                      </div>
                    </div>
                  </div>
            ...
            <section class="ftco-section testimony-section img" style="background-image: url({{asset('looks/images/bg_7.jpg')}});">
                <div class="overlay"></div>
              <div class="container">
                  <div class="row justify-content-center">
                      <div class="col-md-7 mb-5 text-center heading-section ftco-animate">
                    <h2 class="mb-4">Clients Says</h2>
                    <p>experince from other hair dressers</p>
                  </div>
                  </div>
                    ...
                    <div class="carousel-testimony owl-carousel">
                      <div class="item">
                        <div class="testimony-wrap text-center">
                          <div class="user-img mb-5" style="background-image: url({{asset('looks/images/person_3.jpg')}})">
                      ...
                      <div class="item">
                        <div class="testimony-wrap text-center">
                          <div class="user-img mb-5" style="background-image: url({{asset('looks/images/person_1.jpg')}})">
                            <span class="quote d-flex align-items-center justify-content-center">
                              <i class="icon-quote-left"></i>
                            </span>
                          </div>
                      ...
                      <div class="item">
                        <div class="testimony-wrap text-center">
                          <div class="user-img mb-5" style="background-image: url({{asset('looks/images/person_2.jpg')}})">
                            <span class="quote d-flex align-items-center justify-content-center">
                              <i class="icon-quote-left"></i>
                            </span>
                          </div>
              ...
              <div class="container">
                <div class="row d-flex">
                  ...
                  <div class="col-md-3 d-flex ftco-animate">
                      ...
                      <a href="blog-single.html" class="block-20" style="background-image: url('{{asset('looks/images/image_1.jpg')}}');">
                      </a>
                  ...
                  <div class="col-md-3 d-flex ftco-animate">
                      <div class="blog-entry align-self-stretch">
                      <a href="blog-single.html" class="block-20" style="background-image: url('{{asset('looks/images/image_2.jpg')}}');">
                      </a>
                      <div class="text pt-4 d-block">
                          <div class="meta mb-3">
                          <div><a href="#">August 12, 2018</a></div>
                  ...
                  <div class="col-md-3 d-flex ftco-animate">
                      <div class="blog-entry align-self-stretch">
                      <a href="blog-single.html" class="block-20" style="background-image: url('{{asset('looks/images/image_3.jpg')}}');">
                      </a>
                      <div class="text pt-4 d-block">
                          <div class="meta mb-3">
                          <div><a href="#">August 12, 2018</a></div>
            ...
            <section class="ftco-quote ftco-animate">
                <div class="container">
                    <div class="row d-flex">
                        <div class="col-md-9 req-quote py-5 align-items-center img" style="background-image: url({{asset('looks/images/bg_1.jpg')}});">
                            <h3 class="ml-md-3">Want your salon shown here?</h3>
          ...
          Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart mx-1" aria-hidden="true"></i> by <a href="https://hollytechsolnz.rf.gd" target="_blank">Holly Tech Solutions</a>
        ...
        <script src="{{asset('looks/js/jquery.min.js')}}"></script>
        <script src="{{asset('looks/js/jquery-migrate-3.0.1.min.js')}}"></script>
        <script src="{{asset('looks/js/popper.min.js')}}"></script>
        <script src="{{asset('looks/js/bootstrap.min.js')}}"></script>
        <script src="{{asset('looks/js/jquery.easing.1.3.js')}}"></script>
        <script src="{{asset('looks/js/jquery.waypoints.min.js')}}"></script>
        <script src="{{asset('looks/js/jquery.stellar.min.js')}}"></script>
        <script src="{{asset('looks/js/owl.carousel.min.js')}}"></script>
        <script src="{{asset('looks/js/jquery.magnific-popup.min.js')}}"></script>
        <script src="{{asset('looks/js/aos.js')}}"></script>
        <script src="{{asset('looks/js/jquery.animateNumber.min.js')}}"></script>
        <script src="{{asset('looks/js/scrollax.min.js')}}"></script>
        <script src="{{asset('looks/js/bootstrap-datepicker.js')}}"></script>
        <script src="{{asset('looks/js/jquery.timepicker.min.js')}}"></script>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
        <script src="{{asset('looks/js/google-map.js')}}"></script>
        <script src="{{asset('looks/js/main.js')}}"></script>
