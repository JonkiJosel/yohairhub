            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->hasRole('admin'))
                        ...
                        <x-nav-link href="{{ route('admin.hairstyles') }}" :active="request()->routeIs('admin.hairstyles*')">
                            {{ __('All Hairstyles') }}
                        </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->hasRole('admin'))
                ...
                <x-responsive-nav-link href="{{ route('admin.hairstyles') }}" :active="request()->routeIs('admin.hairstyles*')">
                    {{ __('All Hairstyles') }}
                </x-responsive-nav-link>

                <x-responsive-nav-link href="{{ route('access_control') }}" :active="request()->routeIs('access_control*')">
                    {{ __('Access Control') }}
                </x-responsive-nav-link>
